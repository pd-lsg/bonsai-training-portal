...
const BONSAI = {
  ...
  food: [
    ...
    },
    {
      ...
      calloutTitle_en: "What the hell does \"Everything\" mean, anyway?",
      calloutTitle_es: "¿Qué chingados significa \"Everything\"?",
      callout_en: "In a real New York bagel shop, there are a dozen-plus varieties on the wall — poppy, sesame, garlic, onion, salt, and more — each one baked separately. \"Everything\" is not one of those flavors. It's all of them: a pinch of poppy seed, sesame seed, dried garlic, dried onion, and coarse salt, blended into a single topping and baked onto the crust. One bagel, a taste of the whole case.\n\nThat context doesn't exist here. Bonsai carries exactly two options — plain or everything — with none of the dozen flavors in between to make sense of the name. A guest who's never stood in a New York bagel shop has no way to know what \"everything\" even refers to, so don't assume they do. Say it plainly: it's a savory, crunchy blend of poppy seed, sesame seed, garlic, onion, and salt — noticeably sharper and saltier than plain. If a guest wants something milder, plain is the one to steer them to.",
      callout_es: "En una verdadera tienda de bagels de Nueva York hay más de una docena de variedades en el mostrador — amapola, ajonjolí, ajo, cebolla, sal, y más — cada una horneada por separado. \"Everything\" no es uno de esos sabores. Es todos ellos: un poco de semilla de amapola, ajonjolí, ajo deshidratado, cebolla deshidratada y sal gruesa, mezclados en un solo aderezo y horneados sobre la corteza. Un bagel, una probada de toda la vitrina.\n\nEse contexto no existe aquí. Bonsai ofrece exactamente dos opciones — natural o everything — sin ninguno de los sabores intermedios que le dan sentido al nombre. Un cliente que nunca ha estado en una tienda de bagels de Nueva York no tiene forma de saber a qué se refiere \"everything\", así que no lo des por hecho. Dilo con claridad: es una mezcla sabrosa y crujiente de semilla de amapola, ajonjolí, ajo, cebolla y sal — notablemente más intensa y salada que el natural. Si un cliente busca algo más suave, el natural es la opción a recomendar.",
