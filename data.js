...
const BONSAI = {
  ...
  ingredients: [
    ...
    { term: "Matcha — First Harvest, Shizuoka", en_t: "Matcha — First Harvest, Shizuoka", es_t: "Matcha — Primera Cosecha, Shizuoka",
      en: "Stone-ground powder from shade-grown tea leaves, harvested once a year. \"First harvest\" (ichibancha) is the earliest and most prized picking — sweeter, less bitter, higher in the amino acids that give matcha its umami depth. Shizuoka, on Japan's Pacific coast, is one of the country's oldest and most respected tea-growing regions. Whisked to order, never from a mix.",
      es: "Polvo molido en piedra a partir de hojas de té cultivadas a la sombra, cosechadas una vez al año. \"Primera cosecha\" (ichibancha) es la recolección más temprana y apreciada — más dulce, menos amarga, con más de los aminoácidos que le dan al matcha su profundidad umami. Shizuoka, en la costa del Pacífico de Japón, es una de las regiones productoras de té más antiguas y respetadas del país. Batido al momento, nunca de una mezcla." },
    { term: "Hojicha", en_t: "Hojicha", es_t: "Hojicha",
      en: "Roasted green tea — the same leaf as sencha, but pan-roasted at high heat afterward, which converts the grassy, vegetal notes into something toasty and caramel-like and drops the caffeine content well below matcha or sencha.",
      es: "Té verde tostado — la misma hoja que el sencha, pero tostada al fuego después de procesada, lo que convierte las notas herbales y vegetales en algo tostado y acaramelado, y reduce la cafeína muy por debajo del matcha o el sencha." },
    { term: "Sencha", en_t: "Sencha", es_t: "Sencha",
      en: "Japan's everyday green tea — steamed rather than pan-fired (the main thing that separates Japanese green teas from Chinese ones), which locks in a bright, grassy, umami-forward flavor. Brewed at a lower temperature than boiling (80°C) to avoid bitterness.",
      es: "El té verde cotidiano de Japón — cocido al vapor en lugar de tostado en sartén (la principal diferencia entre los tés verdes japoneses y los chinos), lo que fija un sabor brillante, herbal y con marcado umami. Se prepara a una temperatura menor al hervor (80°C) para evitar el amargor." },
    { term: "Mugicha", en_t: "Mugicha", es_t: "Mugicha",
      en: "Roasted barley tea, cold-brewed — no tea leaf at all, and no caffeine. A summer staple across Japan, poured over ice; the menu's own note calls it \"Japan's answer to a hot afternoon,\" which Tulum has no shortage of.",
      es: "Té de cebada tostada, preparado en frío — no lleva hoja de té y no tiene cafeína. Un clásico del verano en todo Japón, servido con hielo; el propio menú lo describe como \"la respuesta japonesa a una tarde calurosa,\" de las que no faltan en Tulum." },
